...
function customizer_library_sabino_options() {
    ...
    $options['sabino-unote-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Adjust Sidebar width<br />- Break Content Area & Widget area into blocks<br />- Break widgets into separate blocks<br /><br />- Set WooCommerce Products amount per row<br />- Set WooCommerce Products amount per page<br />- Remove Products border<br />- Set WooCommerce Shop/Archive/Single pages to Left Sidebar<br />- Set WooCommerce Shop/Archive/Single pages to Full Width', 'sabino' )
    );
    ...
    $options['sabino-unote-blog-list'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Set Blog to Grid/Blocks Layout<br />- Set amount of Grid Layout columns<br />- Set Blog List/Archive/Single pages to Left Sidebar<br />- Set Blog List/Archive/Single pages to Full Width<br />- Option to add Author Block to Blog single pages<br />- Display Blog list posts summary/excerpt/shortened content', 'sabino' )
    );
